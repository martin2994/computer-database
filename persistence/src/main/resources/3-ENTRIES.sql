insert into company (id,name,logo) values (  1,'Apple Inc.','https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg');
insert into company (id,name,logo) values (  2,'Thinking Machines','https://www.freeiconspng.com/uploads/no-image-icon-15.png');
insert into company (id,name,logo) values (  3,'RCA','https://upload.wikimedia.org/wikipedia/en/8/8e/RCA_Electronics_%28_logo%29.svg');
insert into company (id,name,logo) values (  4,'Netronics','http://mitc-ae.net/images/clients/netronics.png');
insert into company (id,name,logo) values (  5,'Tandy Corporation','https://upload.wikimedia.org/wikipedia/en/b/b4/Tandy_logo_UK.png');
insert into company (id,name,logo) values (  6,'Commodore International','http://fracademic.com/pictures/frwiki/67/Commodore_logo.png');
insert into company (id,name,logo) values (  7,'MOS Technology','https://upload.wikimedia.org/wikipedia/commons/0/0b/MOS_Technology_Logo.svg');
insert into company (id,name,logo) values (  8,'Micro Instrumentation and Telemetry Systems','https://upload.wikimedia.org/wikipedia/commons/a/a2/MITS_LOGO_1973.svg');
insert into company (id,name,logo) values (  9,'IMS Associates, Inc.','https://www.freeiconspng.com/uploads/no-image-icon-15.png');
insert into company (id,name,logo) values ( 10,'Digital Equipment Corporation','http://fracademic.com/pictures/frwiki/68/Digital_dec_logo.png');
insert into company (id,name,logo) values ( 11,'Lincoln Laboratory','https://yt3.ggpht.com/a-/ACSszfHBYKBsVINa9WVupcR9i4zhyL-L9XB-Ox7Ecw=s900-mo-c-c0xffffffff-rj-k-no');
insert into company (id,name,logo) values ( 12,'Moore School of Electrical Engineering','https://www.freeiconspng.com/uploads/no-image-icon-15.png');
insert into company (id,name,logo) values ( 13,'IBM','https://acclaim-production-app.s3.amazonaws.com/images/854d76bf-4f74-4d51-98a0-d969214bfba7/IBM%2BLogo%2Bfor%2BAcclaim%2BProfile.png');
insert into company (id,name,logo) values ( 14,'Amiga Corporation','https://rhodblog.files.wordpress.com/2015/03/amiga_logo.jpg');
insert into company (id,name,logo) values ( 15,'Canon','http://www.canon.fr/Images/Canon_Logo_350_tcm79-959888.jpg');
insert into company (id,name,logo) values ( 16,'Nokia','http://www.smsenvoi.com/blog/wp-content/uploads/2013/08/Nokia-Logo.jpg');
...
insert into company (id,name,logo) values ( 25,'Sinclair Research Ltd','http://www.sinclairresearch.com/assets/logo.png');
insert into company (id,name,logo) values ( 26,'Xerox','http://likeit.uz/wp-content/uploads/2017/06/4ded242b1b71dab57d1d15e57ef9d786.jpg');
insert into company (id,name,logo) values ( 27,'Hewlett-Packard','https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/HP_logo_2012.svg/280px-HP_logo_2012.svg.png');
insert into company (id,name,logo) values ( 28,'Zemmix','https://upload.wikimedia.org/wikipedia/en/a/ac/Zemmix_logo_003.png');
insert into company (id,name,logo) values ( 29,'ACVS','https://www.freeiconspng.com/uploads/no-image-icon-15.png');
insert into company (id,name,logo) values ( 30,'Sanyo','https://upload.wikimedia.org/wikipedia/commons/e/ed/Sanyo_logo.svg');
insert into company (id,name,logo) values ( 31,'Cray','https://fr.m.wikipedia.org/wiki/Cray_(entreprise)#/media/Fichier%3ACray_logo.png');
insert into company (id,name,logo) values ( 32,'Evans & Sutherland','https://i.vimeocdn.com/portrait/4459805_300x300');    
insert into company (id,name,logo) values ( 33,'E.S.R. Inc.','https://www.freeiconspng.com/uploads/no-image-icon-15.png');
insert into company (id,name,logo) values ( 34,'OMRON','https://fr.m.wikipedia.org/wiki/Omron#/media/Fichier%3AOMRON_Logo.svg');
insert into company (id,name,logo) values ( 35,'BBN Technologies','https://www.generalcatalyst.com/wp-content/uploads/2017/10/logo-bbn_technologies-300x300.png');
insert into company (id,name,logo) values ( 36,'Lenovo Group','https://upload.wikimedia.org/wikipedia/commons/b/bd/Branding_lenovo-logo_lenovologoposred_low_res.png');
insert into company (id,name,logo) values ( 37,'ASUS','https://dlcdnimgs.asus.com/20160129_cosmo/cosmo/images/asus_logo.jpg');
insert into company (id,name,logo) values ( 38,'Amstrad','https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/Amstrad_logo.svg/1024px-Amstrad_logo.svg.png');
insert into company (id,name,logo) values ( 39,'Sun Microsystems','https://upload.wikimedia.org/wikipedia/en/thumb/c/c8/Sun_Microsystems_logo.svg/1200px-Sun_Microsystems_logo.svg.png');
insert into company (id,name,logo) values ( 40,'Texas Instruments','https://d3nevzfk7ii3be.cloudfront.net/igi/DGEWMHDbQuSMNFna.large');
insert into company (id,name,logo) values ( 41,'HTC Corporation','https://upload.wikimedia.org/wikipedia/commons/thumb/d/d5/HTC.svg/280px-HTC.svg.png');
insert into company (id,name,logo) values ( 42,'Research In Motion','http://cdn1.knowyourmobile.com/sites/knowyourmobilecom/files/styles/gallery_wide/public/0/70/174548.jpg?itok=9-eX6ToI');
insert into company (id,name,logo) values ( 43,'Samsung Electronics','https://dyw7ncnq1en5l.cloudfront.net/optim/news/67/67333/samsung_logo.jpg');
...
insert into user(username,password,enabled) values('admin','$2a$10$DKGEkZuJJT83bP0ZJQ1jLuwX7NjmlI/X/AQ.oRiOxH0kIdKSXJZUy',true);
insert into user(username,password,enabled) values('user','$2a$10$m6H7T8SeF2o2QClrXa2cOu4D4BreYAB42oDO.Pqdg..ZA27s48nhu',true);

insert into role(username,authority) values('admin','ROLE_ADMIN');
insert into role(username,authority) values('user','ROLE_USER');
