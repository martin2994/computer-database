...
import com.excilys.cdb.SpringTestConfigurationDAO;
...
@ContextConfiguration(classes = SpringTestConfigurationDAO.class)
public class ComputerDAOTest {
	...
	public void testFindPerPageBadResultPerPage() {
		// assertThrows(InvalidComputerException.class, () -> computerDAO.findPerPage(0,
		// -1));
	}
	 ...
	 */
	@Test
	public void testFindByNamePerPagePageInf() throws InvalidComputerException {
		exception.expect(InvalidComputerException.class);
		computerDAO.findByNamePerPage("Apple", -1, 10);
	}
	 ...
	 */
	@Test
	public void testFindByNamePerPageResultInf() throws InvalidComputerException {
		exception.expect(InvalidComputerException.class);
		computerDAO.findByNamePerPage("Apple", 10, -1);
	}
	 ...
	 */
	@Test
	public void testAdd() throws NoObjectException, InvalidComputerException {
	 ...
	 */
	@Test
	public void testAddNull() throws NoObjectException, InvalidComputerException {
	 ...
	 */
	@Test
	public void testAddWithId() throws NoObjectException, InvalidComputerException {
	 ...
	 */
	@Test
	public void testAddDate() throws NoObjectException, InvalidComputerException {
	 ...
	 */
	@Test
	public void testUpdate() throws NoObjectException, InvalidComputerException {
	 ...
	 */
	@Test
	public void testUpdateWithIdZero() throws NoObjectException, InvalidComputerException {
		Computer computer = computerTest;
		computer.setId(0L);
	 ...
	 */
	@Test
	public void testUpdateDate() throws NoObjectException, InvalidComputerException {
	...
	public void testDeleteList() {
		...
		ids.add(8L);
		ids.add(9L);
		assertTrue(computerDAO.deleteList(ids));
	...
	public void testDeleteListNoComputer() {
		...
		ids.add(100L);
		ids.add(110L);
		assertFalse(computerDAO.deleteList(ids));
	}
