...
public class CompanyDAOTest {
	...
	public void testFindPerPageBadResultPerPage() {
		// assertThrows(InvalidCompanyException.class, () -> companyDAO.findPerPage(0,
		// -1));
	}
	 ...
	 */
	@Test
	public void testFindPerPagePageInf() throws InvalidCompanyException {
		exception.expect(InvalidCompanyException.class);
		companyDAO.findPerPage(-1, 10);
	}
