...
public class UserController {
	...
	@GetMapping
	public ResponseEntity<UserDTO> isExsitingUser(@RequestParam(name="username") String username){
		return new ResponseEntity<>(DTOMapper.fromUser(userDetailsServiceImp.getUser(username)),HttpStatus.OK);
	}
